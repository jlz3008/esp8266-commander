...
static char current_prompt[CONFIG_PROMPT_BUF] = _PROMPT_DEFAULT;
static int current_prompt_len = _PROMPT_LEN ;
static int echo = 1;

void ICACHE_FLASH_ATTR microrl_set_prompt(const char* prompt)
{
	if (strlen(prompt) + 4 > CONFIG_PROMPT_BUF) {
        console_printf("error: prompt too long - increase CONFIG_PROMPT_BUF\n");
		return;
	}	
...
static ICACHE_FLASH_ATTR void print_hist (ring_history_t * pThis)
{
	console_printf ("\n");
...
//*****************************************************************************
inline static void ICACHE_FLASH_ATTR print_prompt (microrl_t * pThis)
{
...
//*****************************************************************************
inline static void ICACHE_FLASH_ATTR terminal_backspace (microrl_t * pThis)
{
		pThis->print ("\033[D \033[D");
}

//*****************************************************************************
inline static void ICACHE_FLASH_ATTR terminal_newline (microrl_t * pThis)
{
	pThis->print (ENDL);
}
...
static int ICACHE_FLASH_ATTR microrl_insert_text (microrl_t * pThis, const char * text, int len)
{
	int i;
...
//*****************************************************************************
static int ICACHE_FLASH_ATTR common_len (const char ** arr)
{
	int len = 0;
	int i = 1;
	while (1) {
...
void ICACHE_FLASH_ATTR microrl_set_echo (int e)
{
	echo = e;
}
