...
void uart_init(uint32_t user_task,uint32_t user_task_rx_signal,uint32_t user_task_rx_tout_signal,uint32_t user_task_err_signal,uint32_t user_task_eot_signal);
